...
-- Numerator: Number of unique females 15-44  who had a LARC removed within 3 months of insertion at a FP visit
-- Denominator: Total unique females 15-44 who had a LARC inserted at a FP visit
-- Modified by:
-- Modifications:
-- =============================================
...
SELECT DISTINCT 
	...
	,NULL
FROM #temp1
WHERE Service_Item_id IN ('J7297', 'J7298' ,'J7300' ,'J7301' ,'J7302', 'J7307')

--select * from #main
--select distinct person_id from #temp1

--***Update Insert Date***
UPDATE #main
SET [LARC_Insert_Date] = MAXDATE
FROM #temp1 t
INNER JOIN
...
SELECT *
FROM #ab a
WHERE a.person_nbr = #main.person_nbr AND a.service_date = #main.[LARC_Insert_Date]
)
...
--***Update device SIM***
UPDATE #main
SET [LARC_Type] = service_item_id
FROM #temp1 t
WHERE service_item_id IN ('J7297', 'J7298', 'J7300' ,'J7301' ,'J7302', 'J7307')
AND t.service_date = #main.LARC_Insert_Date AND t.person_id = #main.person_id
