...
SELECT DISTINCT
'English' AS 'Language'
,(SELECT COUNT (DISTINCT person_id) FROM #demo WHERE [language] = 'english' AND sex = 'f') AS [female]
,(SELECT COUNT (DISTINCT person_id) FROM #demo WHERE [language] = 'english' AND sex = 'f' AND contraceptive = 'y') AS [female contra]
,(SELECT COUNT (DISTINCT person_id) FROM #demo WHERE [language] = 'english' AND sex = 'f' AND ab = 'y') AS [female ab]
,(SELECT COUNT (DISTINCT person_id) FROM #demo WHERE [language] = 'english' AND sex = 'm') AS [male]
INTO #lang

INSERT INTO #lang
SELECT DISTINCT
'Spanish' AS 'Language'
,(SELECT COUNT (DISTINCT person_id) FROM #demo WHERE [language] = 'spanish' AND sex = 'f') AS [female]
,(SELECT COUNT (DISTINCT person_id) FROM #demo WHERE [language] = 'spanish' AND sex = 'f' AND contraceptive = 'y') AS [female contra]
,(SELECT COUNT (DISTINCT person_id) FROM #demo WHERE [language] = 'spanish' AND sex = 'f' AND ab = 'y') AS [female ab]
,(SELECT COUNT (DISTINCT person_id) FROM #demo WHERE [language] = 'spanish' AND sex = 'm') AS [male]

INSERT INTO #lang
SELECT DISTINCT
'Other' AS 'Language'
,(SELECT COUNT (DISTINCT person_id) FROM #demo WHERE [language] = 'other' AND sex = 'f') AS [female]
,(SELECT COUNT (DISTINCT person_id) FROM #demo WHERE [language] = 'other' AND sex = 'f' AND contraceptive = 'y') AS [female contra]
,(SELECT COUNT (DISTINCT person_id) FROM #demo WHERE [language] = 'other' AND sex = 'f' AND ab = 'y') AS [female ab]
,(SELECT COUNT (DISTINCT person_id) FROM #demo WHERE [language] = 'other' AND sex = 'm') AS [male]

INSERT INTO #lang
SELECT DISTINCT
'Unknown' AS 'Language'
,(SELECT COUNT (DISTINCT person_id) FROM #demo WHERE [language] = 'unknown' AND sex = 'f') AS [female]
,(SELECT COUNT (DISTINCT person_id) FROM #demo WHERE [language] = 'unknown' AND sex = 'f' AND contraceptive = 'y') AS [female contra]
,(SELECT COUNT (DISTINCT person_id) FROM #demo WHERE [language] = 'unknown' AND sex = 'f' AND ab = 'y') AS [female ab]
,(SELECT COUNT (DISTINCT person_id) FROM #demo WHERE [language] = 'unknown' AND sex = 'm') AS [male]
