...
--SET @Location_1 = '68C7DDB4-834A-4ABC-B3EB-87BF71D60F41'
...
--Updates #pay with the encounters financial class --9398
--Fpact
UPDATE #pay2
SET [finClass] = '4110'
WHERE #pay2.payer IN
...
--Medi-Cal Managed Care-4130 --5109
UPDATE #pay2
SET [finClass] = '4130'
WHERE #pay2.payer IN
(
...
--select distinct person_id, finclass from #pay
--where finclass is null
--where finClass = '0'
...
--select * from #pay --15240

--select finClass, count(finClass) AS 'class' --15232
--from #pay
--group by finClass

--select finClass, count(finClass) AS 'class' --13758
-- from #finClass
--group by finClass

----13791 patients
----13758 financial visits


--select distinct person_id from #pay
--select distinct person_id from #demo